...
namespace Lab_4
{
    class Program
    {
        ...
        {
            return (5 * Math.Sqrt(Math.Pow(2.76*x, 3) + Math.Pow(0.5*x, 5) - Math.Cos(0.5*x))) / Math.Sin(2.76*x);
        }
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Кiлькiсть елементiв масиву, менших за середнє значення: {0}", n);
